...
class WizardMncArStatementReport(models.TransientModel):
    ...
    def get_datas_report(self):
        ...
        for move in move_ids:
            ...
            move_vals.append({
                ...
                'partner_name': move.partner_id.alias_name,
        ...
        for partner, items in grouped.items():
            ...
            DATA.append({
                ...
                'partner_name': partner_id.alias_name if partner_id.alias_name else partner_id.name,
    ...
    def button_print_pdf(self):
        template = 'mnc_xlsx_reporting.mnc_ar_statement_report'
        ...
        return self.env.ref('mnc_xlsx_reporting.action_mnc_ar_statement_report').report_action(None, data=values)
