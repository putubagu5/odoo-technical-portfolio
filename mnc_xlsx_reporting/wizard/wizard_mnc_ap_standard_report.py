...
class WizardMncApStandardReport(models.TransientModel):
    ...
    def button_print_excel(self):
        ...
        worksheet1.write(i, 7, 'Curr', header_table)
        ...
        worksheet1.write(i, 11, 'Voucher Num', header_table)
        ...
        for bill in bills_ids:
            data_vals.append({
                ...
                'partner_name': bill.partner_id.alias_name if bill.partner_id.alias_name else bill.partner_id.name,
