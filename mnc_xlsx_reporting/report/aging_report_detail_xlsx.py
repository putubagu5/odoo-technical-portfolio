...
class AgingReportDetailXLSX(models.AbstractModel):
    ...
    def set_header_data(self, arguments):
        sheet, wizard, company = arguments['sheet'], arguments['wizard'], arguments['company']
        ...
        sheet.merge_range(header_row, 0, header_row, 10, 'Aging Account Receivable Per Customer Summary', style['title_style'])
        header_row += 1
        ...
        sheet.write(header_row, 0, company.name, style['bold_align_left'])
    ...
    def set_table_header_data(self, arguments):
        ...
        headers = [
            'Product', 'PO Number', 'PO Type', 'Transaction Type', 'Advertiser',
    ...
    def set_table_body_data(self, arguments):
        ...
        for data in detail_data:
            ...
            for inv_data in data['invoices']:
                ...
                if valid_applied_misc:
                    applied_amount = valid_applied_misc[0].applied_amount
                if applied_amount:
                ...
                current_amount = invoice.amount_total - invoice.amount_residual
                if current_amount:
