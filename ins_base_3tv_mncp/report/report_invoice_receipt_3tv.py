...
class ReportInvoiceReceipt3tv(models.AbstractModel):
    _name = 'report.ins_base_3tv_mncp.report_invoice_receipt_3tv_container'
    ...
    def _prepare_report_data(self):
        ...
        for inv in invoices:
            ...
            inv_data[inv.payment_reference] = [
                {
                    'mo_numbers_gen21': inv.mo_numbers_gen21,
                    'name': x.name,
