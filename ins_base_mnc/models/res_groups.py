...
class ResGroups(models.Model):
    ...
    def _update_user_groups_view(self):
        ...
        if self._context.get('install_filename') or self._context.get(MODULE_UNINSTALL_FLAG):
            ...
            group_forbidden = view.env.ref('ins_base_mnc.group_forbidden')
            xml1, xml2, xml3 = [], [], []
            xml_by_category = {}
                ...
                if app.xml_id == 'base.module_category_user_type':
                    ...
                    for g in gs:
                        ...
                        if g == group_no_one:
                            ...
                            if g == group_forbidden:
                                cpattrs = attrs.copy()
                                cpattrs['attrs'] = str({'readonly': 1, 'invisible': 1})
                                xml3.append(E.field(name=field_name, **cpattrs))
                            else:
