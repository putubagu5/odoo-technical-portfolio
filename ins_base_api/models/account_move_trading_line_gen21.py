...
class AccountMoveTradingLineGen21(models.Model):
    _name = "account.move.trading.line.gen21"
    _order = "line_number asc, id asc"

    move_id_trading_gen21 = fields.Many2one('account.move.trading.gen21', string='Journal Entry Gen21',
    ...
    attribute6 = fields.Char('Episode Title')
    ...
    state = fields.Selection(selection=[
        ...
        related="move_id_trading_gen21.state")
    company_id = fields.Many2one('res.company', string='Company', related="move_id_trading_gen21.company_id")
