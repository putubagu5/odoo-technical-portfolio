...
class InventoryCostsLineGen21(models.Model):
    _name = "inventory.costs.line.gen21"

    inventory_costs_id_gen21 = fields.Many2one('inventory.costs.gen21', string='Journal Entry Gen21',
    ...
    state = fields.Selection(selection=[
        ...
        default='draft', related="inventory_costs_id_gen21.state")
    company_id = fields.Many2one('res.company', string='Company', related="inventory_costs_id_gen21.company_id")
