...
class ResCheckLine(models.Model):
    _name = 'res.check.line'
    _description = 'Check Line'

    check_id = fields.Many2one('res.check', 'Related Check')
    # journal_id = fields.Many2one('account.journal', related="check_id.journal_id", 'Related Journal')
