...
class ResGiro(models.Model):
    ...
    line_ids = fields.One2many('res.giro.line', 'giro_id', 'Used Giro')
    ...
    def _check_name_journal_id(self):
        ...
        existing = self.env['res.giro'].search_count(domain)
        if existing:
    ...
    def button_generate(self):
        """ function to generate giro numbers based on range """
