...
class ResPaymentDocumentLine(models.Model):
    _name = 'res.payment.document.line'
    _description = 'Payment Document Line'
    _order = 'name'

    document_id = fields.Many2one('res.payment.document', 'Related Document')
    # journal_id = fields.Many2one('account.journal', related="document_id.journal_id", 'Related Journal')
