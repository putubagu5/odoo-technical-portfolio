...
class WizardMassAssetDetail(models.TransientModel):
    _name = 'wizard.mass.asset.detail'
    _description = 'Mass Asset Detail'
    ...
    generate_id = fields.Many2one('wizard.mass.asset.generate', 'Generate')
    ...
    line_number = fields.Integer('Line No', related='invoice_line_id.line_number')
